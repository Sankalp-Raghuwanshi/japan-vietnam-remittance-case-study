...
An independent market research case study exploring cross-border remittance and digital identity friction faced by Vietnamese workers in Japan — built as applied research ahead of a Product Innovation internship application (FinTech, Digital Identity & Japan–Vietnam Services).
...
- **`Japan_Vietnam_Case_Study_Presentation.pptx`** — 9-slide presentation summarizing the same research for a live walkthrough.
